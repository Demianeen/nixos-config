...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Feliche-Demian Netliukh"
    user-mail-address "51330172+Demianeen@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/demian/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/demian/bin" "/profile/bin" "/Users/demian/.npm-packages/bin" "/Users/demian/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
